    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb small mb-0">
                <li class="breadcrumb-item"><a href="<?= base_url('dashboard') ?>" class="text-decoration-none">Utama</a></li>
...
<div class="card border-0 shadow-sm mb-4">
    <div class="card-body p-4">
        <h6 class="fw-bold text-dark mb-3"><i class="bi bi-filter-left me-1 text-primary"></i> Tapis & Jana Laporan</h6>
        ...
        <form action="<?= base_url('reports/generate') ?>" method="POST" autocomplete="off">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-3">
                    <label for="start_date" class="form-label small fw-semibold text-secondary">Tarikh Mula</label>
                    <input type="date" class="form-control" id="start_date" name="start_date" 
                           value="<?= esc($filters['start_date'] ?? '') ?>">
                </div>

                <div class="col-md-3">
                    <label for="end_date" class="form-label small fw-semibold text-secondary">Tarikh Tamat</label>
                    <input type="date" class="form-control" id="end_date" name="end_date" 
                           value="<?= esc($filters['end_date'] ?? '') ?>">
                </div>

                <div class="col-md-3">
                    <label for="category" class="form-label small fw-semibold text-secondary">Kategori</label>
                ...
                <div class="col-md-3">
                    <label for="status" class="form-label small fw-semibold text-secondary">Status Item</label>
                ...
                <div class="col-md-12 text-end mt-4 pt-2 border-top">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-semibold shadow-sm">
                        <i class="bi bi-gear-fill me-1"></i> Jana Laporan
                    </button>
                </div>
...
<div class="row g-3 mb-4">
    <div class="col-sm-6 col-md-3">
        <div class="card border-0 shadow-sm bg-primary text-white">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    <span class="small opacity-75 d-block fw-medium">Jumlah Rekod</span>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="card border-0 shadow-sm bg-success text-white">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    <span class="small opacity-75 d-block fw-medium">Status Aktif</span>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="card border-0 shadow-sm bg-warning text-dark">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    <span class="small opacity-75 d-block fw-medium">Status Pending</span>
    ...
    <div class="col-sm-6 col-md-3">
        <div class="card border-0 shadow-sm bg-danger text-white">
            <div class="card-body p-3 d-flex align-items-center justify-content-between">
                <div>
                    <span class="small opacity-75 d-block fw-medium">Tidak Aktif</span>
...
<div class="card border-0 shadow-sm">
    <div class="card-body p-0">
        <div class="p-4 border-bottom d-flex justify-content-between align-items-center">
            <h6 class="fw-bold text-dark mb-0"><i class="bi bi-list-task me-1 text-primary"></i> Data Hasil Janaan</h6>
                            ...
                            <?php if (is_array($item)): ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php else: ?>
                                            <span class="badge bg-danger-subtle text-danger border border-danger-subtle px-2 py-1.5">Tidak Aktif</span>
                                        <?php endif; ?>
                                    </td>
                                    <td class="text-secondary small">
                                        <i class="bi bi-person me-1 text-muted"></i><?= esc($item['creator_name'] ?? 'Sistem') ?>
                                    </td>
                    ...
                    <?php else: ?>
                        <tr>
                            <td colspan="6" class="text-center py-5 text-muted">
                                ...
                                <h6 class="fw-bold text-dark mb-1">Tiada Data Laporan Dipaparkan</h6>
                                <p class="text-muted small mb-0">Sila pilih julat tarikh atau parameter penapis di atas, kemudian klik butang <strong>Jana Laporan</strong>.</p>
                            </td>
                        </tr>
                    <?php endif; ?>
                </tbody>
